...
export const TableElements: TableElement[] = [
  {name: "id", tableClass: "block", extensionClass: "hidden", sortable: true, classes: "ellipsis", editable: false},
  ...
  {name: "accessTokenValidity", width: "w-28", tableClass: "hidden lg:block", extensionClass: "block lg:hidden", sortable: true, editable: true},
  {name: "refreshTokenValidity", width: "w-28", tableClass: "hidden lg:block", extensionClass: "block lg:hidden", sortable: true, editable: true},
