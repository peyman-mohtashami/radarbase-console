...
export class ProtocolListPageComponent implements OnInit, OnDestroy {
  ...
  public dialogService = inject(ProtocolDialogService);
  ...
  entities = signal<AppProtocol[]>(this.activatedRoute.snapshot.data['entities']);
  processedEntities = signal<AppProtocol[]>(this.activatedRoute.snapshot.data['entities']);
  visibleEntities = signal<AppProtocol[]>([]);
  ...
  private applyPagination(entities: AppProtocol[]): AppProtocol[] {
  ...
  private getFilteredEntities(): AppProtocol[] {
