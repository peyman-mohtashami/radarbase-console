...
export interface QuestionnaireCheckboxQuestionForm extends Record<string, unknown> {
  id: string;
  field_name: string;
  field_type: string;
...
export class CheckboxQuestionComponent {
  ...
  protected model = signal<QuestionnaireCheckboxQuestionForm>({ //this.dialogData.restoredModel ??{
    ...this._question,
  ...
  toAppQuestion(model: QuestionnaireCheckboxQuestionForm): AppQuestion {
