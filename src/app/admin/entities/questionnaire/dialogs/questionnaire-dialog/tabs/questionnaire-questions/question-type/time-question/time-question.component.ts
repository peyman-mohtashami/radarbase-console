...
export interface QuestionnaireTimeQuestionForm extends Record<string, unknown> {
  id: string;
  field_name: string;
  field_type: string;
...
export class TimeQuestionComponent {
  ...
  protected model = signal<QuestionnaireTimeQuestionForm>({ //this.dialogData.restoredModel ??{
    ...this._question,
  ...
  toAppQuestion(model: QuestionnaireTimeQuestionForm): AppQuestion {
