...
export interface QuestionnaireDescriptiveQuestionForm extends Record<string, unknown> {
  id: string;
  field_name: string;
  field_type: string;
...
export class DescriptiveQuestionComponent {
  ...
  protected model = signal<QuestionnaireDescriptiveQuestionForm>({ //this.dialogData.restoredModel ??{
    ...this._question,
  ...
  toAppQuestion(model: QuestionnaireDescriptiveQuestionForm): AppQuestion {
