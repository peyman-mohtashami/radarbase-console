...
export class RangeQuestionComponent {
  ...
  protected model = signal<QuestionnaireRangeQuestionForm>({ //this.dialogData.restoredModel ??{
    ...this._question,
  ...
  toAppQuestion(model: QuestionnaireRangeQuestionForm): AppQuestion {
  ...
  normalizeQuestion(question: AppQuestion) {
    const updatedQuestion: AppQuestion = {
      ...
      show_selected_label: question.show_selected_label,
      show_code: question.show_code,
    }
