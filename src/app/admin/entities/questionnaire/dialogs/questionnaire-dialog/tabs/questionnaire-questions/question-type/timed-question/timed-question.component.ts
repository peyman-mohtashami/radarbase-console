...
export interface QuestionnaireTimedQuestionForm extends Record<string, unknown> {
  id: string;
  field_name: string;
  field_type: string;
...
export class TimedQuestionComponent {
  ...
  protected model = signal<QuestionnaireTimedQuestionForm>({ //this.dialogData.restoredModel ??{
    ...this._question,
  ...
  toAppQuestion(model: QuestionnaireTimedQuestionForm): AppQuestion {
