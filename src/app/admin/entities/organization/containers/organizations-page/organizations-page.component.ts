...
import {ClientDialogService} from '../../../client/services/client-dialog.service';
import {ClientTableRowComponent} from '../../../client/components/client-table-row/client-table-row.component';
...
export class OrganizationsPageComponent extends BaseEntitiesPageComponent<AppOrganization> implements OnInit, OnDestroy {
  ...
  protected override readonly GRID_VIEW_ENABLED = true;
...
//   protected dialogService = inject(OrganizationDialogService);
//
...
//       const entity = this.visibleEntities().find(e => e.id.toString() === entityId);
//       switch (action) {
//         case 'add':
