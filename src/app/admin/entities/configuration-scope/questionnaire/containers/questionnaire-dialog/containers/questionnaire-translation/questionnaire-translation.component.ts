import {Component, effect, input, OnInit, output, untracked} from '@angular/core';
...
export class QuestionnaireTranslationComponent implements OnInit {
  ...
  //         debounceTime(300)
  //       ).subscribe(change => {
  //         console.log('Class: QuestionnaireTranslationComponent, Function: , Line 98 change' , change);
