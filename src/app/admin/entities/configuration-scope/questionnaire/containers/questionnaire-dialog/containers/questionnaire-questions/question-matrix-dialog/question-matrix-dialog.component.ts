...
@Component({
  selector: 'app-question-matrix-dialog',
  imports: [
    ReactiveFormsModule,
    DialogTitleComponent,
    MatDialogContent,
  ...
  templateUrl: './question-matrix-dialog.component.html'
})
export class QuestionMatrixDialogComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  dialogRef = inject(MatDialogRef<QuestionMatrixDialogComponent>);
