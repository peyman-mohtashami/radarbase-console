...
import { SubjectDialogPairSourceComponent } from '../../containers/subject-dialog-pair-source/subject-dialog-pair-source.component';
...
@Component({
  selector: 'rb-pair-source',
  templateUrl: './pair-source.component.html',
  imports: [
    MatMenuItem,
    TranslatePipe,
    MatIconButton
...
export class PairSourceComponent {
