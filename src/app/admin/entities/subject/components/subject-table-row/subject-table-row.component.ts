...
import {
  SubjectDataDetailsPageComponent
} from "../../containers/subject-data-details-page/subject-data-details-page.component";
import {SelectionModel} from "@angular/cdk/collections";
import {instanceConfig, entitiesConfig} from "../../../../../core/config/store/config.selectors";
...
export class SubjectTableRowComponent {
  ...
  actionEvent = output<{mode: DialogMode, entity: AppSubject}>()
  ...
  onAction(mode: DialogMode, entity: AppSubject) {
